function cutouts_simple_extrude_1_2_outline_fn(){
    return new CSG.Path2D([[37.5,-160.5],[37.5,-82.5]]).appendArc([39.5,-80.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([73.5,-80.5]).appendArc([75.5,-78.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([75.5,-77.5]).appendArc([77.5,-75.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([92.5,-75.5]).appendArc([94.5,-73.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([94.5,-72.5]).appendPoint([117.5,-72.5]).appendArc([119.5,-74.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([119.5,-75.5]).appendArc([121.5,-77.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([155.5,-77.5]).appendArc([157.5,-79.5],{"radius":2,"clockwise":true,"large":false}).appendPoint([157.5,-139.4818196]).appendArc([158.3233114,-141.0990406],{"radius":2,"clockwise":false,"large":false}).appendPoint([189.4854302,-163.772573]).appendArc([189.8408305,-166.6753693],{"radius":2,"clockwise":true,"large":false}).appendPoint([170.3278889,-189.9299875]).appendArc([167.5102247,-190.1765012],{"radius":2,"clockwise":true,"large":false}).appendPoint([135.7474402,-163.5243603]).appendArc([135.1531641,-162.6750296],{"radius":2,"clockwise":true,"large":false}).appendPoint([134.4784195,-160.8172418]).appendArc([132.5985681,-159.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([83.5,-159.5]).appendArc([81.5,-161.5],{"radius":2,"clockwise":false,"large":false}).appendPoint([81.5,-162.5]).appendPoint([39.5,-162.5]).appendArc([37.5,-160.5],{"radius":2,"clockwise":true,"large":false}).close().innerToCAG()
.subtract(
...
.union(
    ...
    new CSG.Path2D([[146.1381756,-158.8627978],[156.8627978,-167.8618244]]).appendPoint([165.8618244,-157.1372022]).appendPoint([155.1372022,-148.1381756]).appendPoint([146.1381756,-158.8627978]).close().innerToCAG()
                ...
                function plate_simple_case_fn() {
                    

                // creating part 0 of case plate_simple
                let plate_simple__part_0 = cutouts_simple_extrude_1_2_outline_fn();

                // make sure that rotations are relative
                let plate_simple__part_0_bounds = plate_simple__part_0.getBounds();
                let plate_simple__part_0_x = plate_simple__part_0_bounds[0].x + (plate_simple__part_0_bounds[1].x - plate_simple__part_0_bounds[0].x) / 2
                let plate_simple__part_0_y = plate_simple__part_0_bounds[0].y + (plate_simple__part_0_bounds[1].y - plate_simple__part_0_bounds[0].y) / 2
                plate_simple__part_0 = translate([-plate_simple__part_0_x, -plate_simple__part_0_y, 0], plate_simple__part_0);
                plate_simple__part_0 = rotate([0,0,0], plate_simple__part_0);
                plate_simple__part_0 = translate([plate_simple__part_0_x, plate_simple__part_0_y, 0], plate_simple__part_0);

                plate_simple__part_0 = translate([0,0,0], plate_simple__part_0);
                let result = plate_simple__part_0;
